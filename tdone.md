...
- ✅ Phase 2 performance baseline — API compression, mounted Prometheus metrics, hot-path refresh-token/org-membership indexes, and an operations smoke script (archived in `docs/PROJECT_HISTORY.md`).
