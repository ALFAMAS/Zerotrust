export const legal = {
  ...
  companyLegalName:
    process.env.NEXT_PUBLIC_COMPANY_LEGAL_NAME ?? "zerotrust, Inc.",
  ...
  privacyEffectiveDate:
    process.env.NEXT_PUBLIC_PRIVACY_DATE ?? "January 1, 2026",
  termsEffectiveDate: process.env.NEXT_PUBLIC_TERMS_DATE ?? "January 1, 2026",
  jurisdiction:
    process.env.NEXT_PUBLIC_JURISDICTION ?? "the laws of the United States",
