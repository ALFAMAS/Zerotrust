...
export const brand = {
  ...
  description: process.env.NEXT_PUBLIC_APP_DESCRIPTION ?? "Enterprise-grade authentication for modern applications. PASETO tokens, WebAuthn passkeys, MFA, RBAC, and more.",
  ...
  heroDescription: process.env.NEXT_PUBLIC_HERO_DESCRIPTION ?? "Enterprise-grade auth without the enterprise complexity. PASETO tokens, WebAuthn passkeys, multi-factor auth, RBAC/ABAC, and real-time anomaly detection — all in one self-hosted platform.",
