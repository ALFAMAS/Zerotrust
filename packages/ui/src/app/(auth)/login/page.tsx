  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
      ...
      <div className="space-y-2">
        <a
          href={`${process.env.NEXT_PUBLIC_ZEROAUTH_URL || "http://localhost:3000"}/auth/oauth/google`}
          className="flex items-center justify-center gap-3 w-full py-2.5 border border-gray-700 hover:border-gray-500 hover:bg-gray-800 text-gray-300 hover:text-white rounded-lg transition-colors text-sm font-medium"
        >
        ...
        <a
          href={`${process.env.NEXT_PUBLIC_ZEROAUTH_URL || "http://localhost:3000"}/auth/oauth/github`}
          className="flex items-center justify-center gap-3 w-full py-2.5 border border-gray-700 hover:border-gray-500 hover:bg-gray-800 text-gray-300 hover:text-white rounded-lg transition-colors text-sm font-medium"
        >
        ...
        <button
          type="button"
          className="flex items-center justify-center gap-3 w-full py-2.5 border border-gray-700 hover:border-gray-500 hover:bg-gray-800 text-gray-300 hover:text-white rounded-lg transition-colors text-sm font-medium"
          onClick={() => alert("Passkey authentication — requires @simplewebauthn/browser in the browser.")}
        >
      ...
      <div className="mt-4 text-center">
        <Link href="/magic-link" className="text-sm text-indigo-400 hover:text-indigo-300">
