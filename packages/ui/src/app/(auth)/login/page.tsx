        ...
        <div className="space-y-3 mb-6">
          {GOOGLE_ENABLED && (
            <a
              ...
              className="flex items-center justify-center gap-3 w-full border border-gray-700 hover:border-gray-500 bg-gray-800 hover:bg-gray-750 text-white py-2.5 px-4 rounded-xl transition-all text-sm font-medium"
            >
