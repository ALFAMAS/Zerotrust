...
const en = {
    ...
    welcome_p2: "You can now sign in to your account and start exploring everything {appName} has to offer.",
    ...
    verify_p1: "Thanks for signing up. Verify your email address to secure your account. You can either tap the button below or enter the code manually. This link and code expire in {minutes} minutes.",
...
const es = {
    ...
    welcome_p2: "Ya puedes iniciar sesión en tu cuenta y empezar a explorar todo lo que {appName} ofrece.",
    ...
    verify_p1: "Gracias por registrarte. Verifica tu dirección de correo para proteger tu cuenta. Puedes tocar el botón de abajo o introducir el código manualmente. Este enlace y código caducan en {minutes} minutos.",
...
const fr = {
    ...
    welcome_p2: "Vous pouvez maintenant vous connecter à votre compte et découvrir tout ce que {appName} propose.",
    ...
    welcome_footer_ignore: "Si vous n'avez pas créé de compte, vous pouvez ignorer cet e-mail en toute sécurité.",
    welcome_team: "— L'équipe {appName}",
    verify_subject: "Vérifiez votre e-mail — {appName}",
    verify_heading: "Confirmez votre e-mail, {name}",
    verify_p1: "Merci de votre inscription. Vérifiez votre adresse e-mail pour sécuriser votre compte. Vous pouvez appuyer sur le bouton ci-dessous ou saisir le code manuellement. Ce lien et ce code expirent dans {minutes} minutes.",
    ...
    verify_ignore: "Si vous n'avez pas créé de compte {appName}, vous pouvez ignorer cet e-mail en toute sécurité.",
...
function tr(locale, key, vars = {}) {
    const loc = (0, locale_1.normalizeLocale)(locale);
    const template = DICTS[loc]?.[key] ?? DICTS[locale_1.DEFAULT_LOCALE][key] ?? key;
...
function htmlLang(locale) {
    return (0, locale_1.normalizeLocale)(locale);
}
