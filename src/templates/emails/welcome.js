...
function welcomeEmailTemplate(data) {
    ...
    const subject = (0, i18n_1.tr)(locale, "welcome_subject", v);
...
<body style="margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,Ubuntu,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f5;padding:40px 16px;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;color:#111827;">
              <h2 style="margin:0 0 16px;font-size:22px;font-weight:600;color:#111827;">${(0, i18n_1.tr)(locale, "welcome_heading", v)}</h2>
              <p style="margin:0 0 24px;font-size:16px;line-height:24px;color:#374151;">
                ${(0, i18n_1.tr)(locale, "welcome_p1", v)}
              </p>
              <p style="margin:0 0 32px;font-size:16px;line-height:24px;color:#374151;">
                ${(0, i18n_1.tr)(locale, "welcome_p2", v)}
              </p>
              <!-- CTA Button -->
              <table cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="background-color:#6366f1;border-radius:8px;">
                    <a href="${loginUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;">${(0, i18n_1.tr)(locale, "welcome_cta", v)}</a>
                  </td>
                </tr>
              </table>
              <p style="margin:0;font-size:14px;line-height:22px;color:#6b7280;">
                ${(0, i18n_1.tr)(locale, "welcome_link_help", v)}<br>
          ...
          <tr>
            <td style="padding:24px 40px;border-top:1px solid #e5e7eb;text-align:center;">
              <p style="margin:0 0 8px;font-size:13px;color:#9ca3af;">
                ${(0, i18n_1.tr)(locale, "welcome_footer_registered", v)}
              </p>
              <p style="margin:0;font-size:13px;color:#9ca3af;">
                ${(0, i18n_1.tr)(locale, "welcome_footer_ignore", v)}
              </p>
            </td>
          </tr>
        </table>
    ...
    const text = `${(0, i18n_1.tr)(locale, "welcome_heading", v)}

${(0, i18n_1.tr)(locale, "welcome_p1", v)}

${(0, i18n_1.tr)(locale, "welcome_cta", v)}:
${loginUrl}

${(0, i18n_1.tr)(locale, "welcome_footer_ignore", v)}

${(0, i18n_1.tr)(locale, "welcome_team", v)}
${appUrl}`;
