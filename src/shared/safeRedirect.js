...
exports.safeRelativeRedirect = safeRelativeRedirect;
exports.appRedirectUrl = appRedirectUrl;
/**
 ...
 */
function safeRelativeRedirect(input, fallback = "/") {
...
function safeHttpOrigin(input, fallback) {
    try {
 ...
 */
function appRedirectUrl(path, appUrl = process.env.APP_URL, fallbackPath = "/") {
...
//# sourceMappingURL=safeRedirect.js.map