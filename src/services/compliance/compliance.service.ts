...
export async function seedSoc2Controls(): Promise<void> {
  ...
  const controls: Omit<Soc2Control, "id">[] = [
    ...
    },
    {
      ...
      evidence: "src/services/ops/slo.service.ts",
      status: "implemented",
    },
    {
      controlId: "A1.2",
      ...
      evidence: "src/services/ops/dbBackup.service.ts",
      status: "implemented",
    },
    {
      controlId: "A1.3",
      ...
      evidence: "src/services/ops/alerting.service.ts",
      status: "implemented",
    },
    {
      controlId: "C1.1",
      ...
      evidence: "src/services/compliance/dataRetention",
      status: "implemented",
    },
    {
      controlId: "C1.2",
...
export async function seedRiskAssessment(year: number): Promise<void> {
  ...
  const risks: Omit<RiskItem, "id">[] = [
    ...
    },
    {
      ...
      riskScore: 10,
      treatment: "mitigate",
      mitigation: "CSFLE field encryption, access reviews, audit logging",
      owner: "dpo",
      status: "mitigated",
    },
    {
      ...
      riskId: "R-006",
      category: "compliance",
      title: "Cross-border data exposure",
      description: "Customer data stored outside expected jurisdiction",
      likelihood: 1,
      impact: 3,
      riskScore: 3,
      treatment: "accept",
      mitigation:
        "Single-server deployment — one Postgres instance and one object-store config per environment; no per-region routing",
      owner: "dpo",
      status: "mitigated",
    },
    {
