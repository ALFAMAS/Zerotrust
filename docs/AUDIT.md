...
| # | Finding | Risk | Status |
| --- | --- | --- | --- |
| T1 | **No UI component/integration tests.** `packages/ui` has only `lib/*.test.ts`; auth/billing/admin page flows are untested. | Medium | **Fixed** (P3.1, P3.7, B4, T5) — happy-dom harness + 27+ page/client tests + server-state modules; UI ratchet at 53% lines (measured 53.85%) |
