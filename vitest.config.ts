...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      // Ratchet thresholds (todo.md P4.5): actual coverage as of 2026-07-03 is
      ...
      // the quarterly maintenance scorecard). UI server-state layer gate lives
      // in packages/ui/vitest.config.ts (P3.1 — ≥85% lines/functions).
      thresholds: {
        lines: 61,
        functions: 59,
        branches: 55,
